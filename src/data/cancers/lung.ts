  ...
  rules: [
    {
      ...
      reason:
        '핀란드 ATBC 연구(남성 흡연자 29,133명)에서 베타카로틴 20 mg 을 매일 드신 군은 폐암 발생이 18 % 많았고 ' +
        '(95 % 신뢰구간 3~36 %), 전체 사망도 8 % 많았습니다(1~16 %). ' +
        '흡연자·석면 노출 노동자 18,314명을 대상으로 한 미국 CARET 연구에서는 베타카로틴 30 mg 에 비타민 A 를 더한 군의 ' +
        '폐암이 28 % 많았고(1.04~1.57) 폐암 사망은 46 % 많아, 예정보다 21개월 일찍 시험이 중단되었습니다. ' +
        '두 연구 모두 "효과가 없었다"가 아니라 "더 나빴다"는 결과입니다. ' +
    ...
    },
    {
      ...
      reason:
        /* '5 % / 6개월' 은 ESPEN 이 아니라 국제 합의 정의(Fearon 2011)의 기준이다 */
        '진행성 폐암 환자의 상당수가 진단 시 이미 체중이 줄어 있습니다. 국제 합의 기준으로는 체중이 5 % 넘게 줄면 ' +
        '악액질에 해당하고, 마르신 분(BMI 20 미만)이나 근감소가 있는 분은 2 % 만 줄어도 같습니다. 이 상태는 ' +
        '치료 완주율 저하와 생존 악화로 이어집니다. 식사량 자체를 늘리기 어려우므로, ' +
        '같은 부피에서 열량과 단백질이 높은 식품(계란, 두부, 치즈, 견과, 경구영양보충 음료)을 우선 배치합니다.',
      evidence: 'G',
      refIds: ['fearon2011', 'espen2021', 'espen-cachexia']
    },
    {
      id: 'lung-ons',
      level: 'prefer',
    ...
    },
    {
      ...
      title: '오메가-3 는 체중이 줄고 있는 분에게 약한 권고로 올라 있습니다',
      reason:
        'ESPEN 은 "진행성 암으로 항암치료를 받으면서 체중이 줄고 있거나 영양불량인 분" 에게 ' +
        '긴사슬 오메가-3(생선기름) 보충을 제안합니다 — 식욕·섭취량·제지방량·체중을 지키려는 목적입니다. ' +
        '다만 권고의 강도는 약하고 근거 수준도 낮습니다. 체중이 안정된 분께 일반적으로 권하는 것이 아닙니다. ' +
        '양은 유럽식품안전청 정리 기준으로 EPA·DHA 합쳐 하루 5 g, EPA 단독으로는 1.8 g 까지가 안전 범위입니다. ' +
    ...
    },
    {
      ...
      reason:
        ...
        '통증 때문에 먹는 양이 줄어드는 것이 이 시기 체중 감소로 이어지므로, ' +
    ...
    },
    {
      ...
      reason:
        ...
        '물리적 손상을 더합니다. 어떤 음식을 뺄지는 국제 지침이 근거 부족으로 권고를 내지 못한 영역이라, ' +
        '통증 기전에 따른 조정으로 보시면 됩니다. 치료가 끝나고 2~4주면 대개 회복되므로 한시적입니다.',
      evidence: 'C',
