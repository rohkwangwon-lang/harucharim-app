  ...
  rules: [
    {
      ...
      reason:
        ...
        '두경부암 환자 540명을 대상으로 방사선치료 첫날부터 비타민 E 400 IU·베타카로틴 30 mg 을 드리는 ' +
        '무작위배정 시험이 있었습니다. 급성 부작용은 줄었지만, 보충 기간 중 이차암이 2.9배 많았습니다 ' +
        '(95 % 신뢰구간 1.56~5.31). ' +
        '재발과 사망은 치료 중에도 담배를 피우신 분에게 몰렸습니다 — 재발 2.4배, 전체 사망 2.3배, ' +
        '두경부암 사망 3.4배였고, 피우지 않으신 분에서는 거의 차이가 없었습니다. ' +
        '저자들은 두 가지가 겹쳐 방사선치료의 효과 자체를 떨어뜨린 것으로 봅니다.',
      evidence: 'A',
    ...
    },
    {
      ...
      reason:
        '침이 줄면 마른 음식은 입안에서 뭉쳐 삼킬 수 없게 됩니다. 걸쭉한 소스·요거트·계란찜처럼 수분을 머금은 형태로 바꾸되, ' +
    ...
    },
    {
      ...
      reason:
        '묽은 액체는 흐르는 속도가 빨라 조절하기 어려울 수 있고, 걸쭉하게 하면 흐름이 느려집니다. ' +
        '다만 어느 단계까지 되게 할지는 연하 평가를 받고 담당 의료진이 정합니다. ' +
        '삼킬 때 기침이 나거나 목소리가 젖은 소리로 변하면 먼저 연하 평가를 받으셔야 합니다.',
      evidence: 'G',
      refIds: ['iddsi']
    }
  ],
