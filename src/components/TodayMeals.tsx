  ...
  return (
    <Section title="오늘 운동" desc="식단과 함께 봐야 의미가 있는 부분입니다.">
      <div className="card p-4">
        {/*
          * 문구를 근거에 맞춰 고쳤다 (2026-09-08 → 09-09 재확인).
          *
          * 예전에는 "부족한 상태에서 운동을 늘리면 근육부터 빠집니다. 가벼운 걷기 정도로 유지하세요"
          * 라고 단정하면서 출처를 하나도 달지 않았다.
          *
          * 처음 고칠 때는 "강도를 올리기보다 먼저 채우시는 편이 낫습니다" 로 두었는데,
          * ESPEN 2021 원문을 받아 보니 그것도 지침과 어긋났다. 권고 12는
          * "maintenance or an increased level of physical activity" 를 강도 strong·근거수준 high 로 권하고,
          * 권고 35는 항암치료 중 "maintaining physical activity **and** to ensure an adequate
          * nutritional intake" 를 함께 권한다. 곧 둘 중 하나를 고르라고 하지 않는다.
          *
          * 그래서 '활동은 그대로, 섭취를 채우기' 로 적는다.
          * 이미 악액질에 이른 경우의 불확실성은 아래 단서에 따로 남긴다.
          */}
        <p className="text-sm leading-relaxed text-stone-700">
          {under ? (
            <>
              오늘 열량이 목표보다 적습니다. 이럴 때 지침이 권하는 것은 둘 중 하나가 아니라{' '}
              <strong>활동은 그대로 두시고 섭취를 채우시는 것</strong>입니다 &mdash;
              항암치료 중에도 신체활동을 유지하면서 영양 섭취를 충분히 하도록 함께 권합니다.
              걷기를 줄이실 일은 아닙니다. 부족이 며칠 이어지면 담당 의료진과 상의하십시오.
            </>
          ) : over ? (
            <>
