...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    lead: '가장 자주 여실 화면입니다. 아침·오전간식·점심·오후간식·저녁을 모두 합한 것이 하루치입니다 — 한 끼 분량이 아닙니다.',
    steps: [
      {
        q: '오늘 상태가 어제와 다르면',
  ...
  },
  {
    ...
    steps: [
      {
        q: '드시고 싶은 요리 계통 고르기',
        a: <>화면 위쪽에서 <strong>한식·양식·중식·일식·동남아식</strong>을 여러 개 함께 고르실 수 있습니다.
          누르는 즉시 추천이 다시 짜입니다. <strong>한식은 늘 나옵니다</strong> —
          여기서 고르시는 것은 '한식 말고 무엇을 더 보고 싶으신가' 입니다.
          '내 식단'의 <strong>달라졌나요?</strong> 에서도 같은 것을 고치실 수 있습니다.</>
      },
      {
        q: '마음에 안 드시면',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        q: '바코드 (베타)',
        a: <>찾기·영양제 화면에서 제품 바코드를 찍어 찾으실 수 있습니다. 아직 시험 중인 기능이라,
          제품명은 대부분 확인되지만 <strong>영양성분까지 나오는 것은 약 30 %</strong> 입니다.
          못 찾으면 번호를 직접 넣거나 이름으로 찾아 주세요.
